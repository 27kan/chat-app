...
RSpec.describe 'メッセージ投稿機能', type: :system do
  before do
    ...
    # room_userを作ることでroomとuserのインスタンスも自動生成してくれる
  ...
  context '投稿に失敗したとき' do
    it '送る値が空の為、メッセージの送信に失敗すること' do
      ...
      expect{
        ...
        # not_to change { Message.count } でもOK
      # 元のページに戻ってくることを確認する
  ...
  context '投稿に成功したとき' do
    ...
    it '画像の投稿に成功すると、投稿一覧に遷移して、投稿した画像が表示されている' do
      ...
      # Rails.root.join にてuser/projects2/chat-appの階層を指定できる
      # chat-app/public/imagesを指定した
